...
function Left() {
    ...
    return (
        <div className="  lg:w-[55%] w-full max-lg:h-full pt-35 lg:pl-6 xl:pl-10  flex flex-col max-lg:justify-center max-lg:items-center ">
            <p className='uppercase max-sm:text-[16px] text-2xl text-[var(--text-muted)] '>Welcome To My World</p>
            ...
            <p className='mt-5 max-sm:text-[20px] text-[22px] max-lg:w-[90%] lg:w-[86%] font-medium text-[var(--text-muted)] '>
            ...
            <div className='mt-10 flex max-sm:gap-1 gap-6'>
                ...
                <a download href={"Aqib Ali - Resume.pdf"}><Button text="Download CV" icon={<Download />} varient='shadowed' /></a>
            </div>
