    ...
    <section className="w-full py-10">
      ...
      <div className="w-full xl:w-[85%] mx-auto md:p-6 p-2  rounded-lg  flex flex-wrap justify-center items-center gap-8">
        {services.map((service) => (
          <div
            key={service.id}
            className=" service-card transition-all duration-300 flex  w-[310px] h-[450px] bg-[#a80a272a] rounded-2xl min-h-[300px] flex-col items-start gap-4 p-6 border-b border-gray-200"
          >
